                ...
                <div className="flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        <motion.div
                            ...
                            <Link to="/" className="text-gray-600 hover:text-sky-500 transition-colors relative group">
                                Features
                        ...
                        <motion.div
                            ...
                            <Link to="/login" className="text-gray-600 hover:text-sky-500 transition-colors relative group">
                                Log In
                                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-sky-400 transition-all duration-300 group-hover:w-full"></span>
                            </Link>
                        </motion.div>
